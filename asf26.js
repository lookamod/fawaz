...
client1.on("ready", () => {
        ...
        client1.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client2.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client2.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client3.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client3.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client4.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client4.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client5.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client5.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client6.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client6.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client7.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client7.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client8.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client8.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client9.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client9.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client10.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client10.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client11.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client11.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client12.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client12.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client13.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client13.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client14.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client14.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client15.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client15.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client16.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client16.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client17.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client17.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client18.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client18.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client19.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client19.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client20.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client20.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client23.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client23.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client24.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client24.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client25.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client25.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client26.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client26.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client27.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client27.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client28.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client28.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client29.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client29.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client30.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client30.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client31.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client31.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client32.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client32.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client33.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client33.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client34.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client34.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client35.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client35.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client36.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client36.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client37.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client37.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client38.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client38.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client39.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client39.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client40.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client40.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client41.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client41.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client42.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client42.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client43.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client43.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client44.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client44.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client45.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client45.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client46.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client46.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client47.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client47.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client48.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client48.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client49.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client49.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
...
client50.on("ready", () => {
	      ...
	      var interval = setInterval (function () {
        client50.channels.get("584979800150638593").send(Math.random().toString(36).substring(7)) 
